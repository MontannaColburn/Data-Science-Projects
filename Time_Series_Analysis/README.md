...
### Overview: 
In this report, I compare the classic Time Series ARIMA model to an LSTM deep neural network in an attempt to predict future sales for Enterprise Training Solutions.
